...
public static void main(String[] args){
    ...
    while (true) {
        ...
        if (Your_Choice == 4) {
            ...
            System.out.println(
                "The number of contactes deleted is :"
                + deleted
            );
...
public class FlightFullException
extends Exception {
...
public class InvalidFlightStatusException
extends Exception {

```
public InvalidFlightStatusException(
    String message
){
...
public int getFlight_houers() {
    return flight_houers;
}


public void setFlight_houers(
    int flight_houers
){
...
public void setEnd_of_passport(
    String end_of_passport
){
...
public String getEnd_of_passport() {
...
public ArrayList<FlightAttendant>
getAttendants(){
...
public static int getTotal_Flight_Today(){
    return total_Flight_Today;
}
...
public void changeStatus(
    ...
    throws InvalidFlightStatusException {

    if (
        this.stauate.equals("Cancelled")
        ||
        this.stauate.equals("Departed")
    ){

        throw new InvalidFlightStatusException(
            "You can not change the status of a cancelled or departed flight."
        );
    }


    if (
        stauate.equals("Scheduled")
        &&
        !(
            newStuate.equals("Boarding")
            ||
            newStuate.equals("Cancelled")
        )
    ){

        throw new InvalidFlightStatusException(
            "Scheduled flight can only become Boarding or Cancelled."
        );
    }


    if (
        stauate.equals("Boarding")
        &&
        !(
            newStuate.equals("Departed")
            ||
            newStuate.equals("Cancelled")
        )
    ){
        ...
        throw new InvalidFlightStatusException(
            "Boarding flight can only become Departed or Cancelled."
        );
    }
...
public void bookPassenger(
    ...
    if (
        ...
        throw new FlightFullException(
            "Sorry you can not book this trip "
            + this.flightNumber
            + " Its Full"
        );
    }
...
public static void saveFlightLog(
    ...
    try {
        ...
        System.out.println(
            "Flight Log successfully Saved To "
            + fileName
        );
...
public static void main(
    ...
    try {
        ...
        flight1.changeStatus(
            "Departed"
        );

    } catch (
        InvalidFlightStatusException e
    ){
    ...
    for (
        ...
        if (
            ...
            person instanceof FlightAttendant
        ){

            System.out.println(
                "Notice: Cabin Crew Attendant"
            );
...
try:
    ...
    print(
        f"[-] Client disconnected unexpectedly: "
        f"{client_address}"
    )
...
<div class="content">
    ...
    ${
        isCode
            ? `<pre class="code">${escapedContent}</pre>`
            : `<pre id="terminal"></pre>`
    }
